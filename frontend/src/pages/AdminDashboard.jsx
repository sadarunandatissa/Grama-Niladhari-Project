...
// import "./AdminDashboard.css";   // Uncomment if you have the CSS file
...
const AdminDashboard = () => {
  const { user, token, logout } = useAuth(); // ← logout is essential
  ...
  // Re‑fetch when token changes (or on mount)
  useEffect(() => {
    fetchData();
  }, [token]);
  ...
  const handleSubmitOfficer = async (e) => {
    ...
    // Append all fields except the ones that are not for officer
