...
export const certificateTypeLabels = {
  ...
  family_composition: "Family Member Certificate (Family Composition)",
  character: "Character Certificate (Recommendation)",
  income: "Income Conirmation Certificate",
  school_admission: "Certificate of Residence for school Admission",
};
